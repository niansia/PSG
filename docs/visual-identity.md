...
The mark turns **P**, **S**, and **G** into one connected object rather than treating the name as three decorated letters:

- **P** is the container for project state.
- **S** is the path through which state changes over time.
